...
- **THEN** the system MAY continue with that one canonical SKU and SHALL record only bounded non-sensitive resolution diagnostics
...
#### Scenario: Typed ambiguity is not inferred from Chinese presentation text
