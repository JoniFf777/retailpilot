...
- [V3.6 Multi-Agent Handoff Summary](docs/v3_multi_agent_handoff_summary.md)
...
V3.6 exposes candidate-context debug metadata for store, miss, selection,
out-of-range, and clear events from `/api/chat`, plus confirmation debug events
from `/api/chat/confirm` when `include_debug=true`.
